...
import { MIRA_CLASS_CONTENT, MIRA_CLASS_CONTENT_TH } from '../content/mira-class';
...
export default function MiraClass() {
  ...
  // Thai-first for the MIRA team; the EN/TH toggle (top-right) swaps language.
  const [lang, setLang] = useState<'th' | 'en'>('th');
  const c = lang === 'th' ? MIRA_CLASS_CONTENT_TH : MIRA_CLASS_CONTENT;
  ...
  // Re-measure scroll positions when the language swaps (text lengths change).
  useEffect(() => {
  ...
  return (
    <MotionConfig reducedMotion={reduce ? 'always' : 'never'}>
      ...
      >
        {/* Language toggle — fixed top-right, above all page chrome */}
        <div
          style={{
            position: 'fixed',
