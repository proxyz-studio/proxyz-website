...
const TH: MiraCopy = {
  ...
  signoff: {
    ...
    signature: 'ทิว',
    name: 'อานนท์ (ทิว) ศักดิ์ศรี · กรรมการผู้จัดการ',
    title: '',
    org: 'บริษัท PROXYZ Studio จำกัด',
    email: 'tew@proxyz.studio',
    phone: '+66 82 280 9050',
  },
  footer: {
    ...
    contact: { label: 'ติดต่อ', lines: ['อานนท์ (ทิว) ศักดิ์ศรี', 'tew@proxyz.studio', '+66 82 280 9050', 'proxyz.studio'] },
...
const EN: MiraCopy = {
  ...
  signoff: {
    ...
    signature: 'Tew',
    name: 'Arnon (Tew) Saksri · Managing Director',
    title: '',
  ...
  footer: {
    ...
    contact: { label: 'Contact', lines: ['Arnon (Tew) Saksri', 'tew@proxyz.studio', '+66 82 280 9050', 'proxyz.studio'] },
