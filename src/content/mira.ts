...
const TH: MiraCopy = {
  ...
  footer: {
    tagline: 'Studio OS. สมองที่ขับเคลื่อนการทำงานของบริษัทคุณ',
    ...
    platform: { label: 'แพลตฟอร์ม', lines: ['Studio OS', 'studioos.proxyz.studio'] },
...
const EN: MiraCopy = {
  ...
  footer: {
    tagline: 'Studio OS. The operating brain for your company.',
    ...
    platform: { label: 'Platform', lines: ['Studio OS', 'studioos.proxyz.studio'] },
    copyright: '© 2026 PROXYZ STUDIO CO., LTD.',
