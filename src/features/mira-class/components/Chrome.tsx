...
export function Header({ cobrand, reduce }: { cobrand: string; reduce: boolean }) {
  return (
    ...
    >
      ...
      {/* Right side intentionally clear — the fixed EN/TH language toggle
          (rendered in MiraClass.tsx) owns the top-right corner. The eyebrow
          already states "AI Workshop", so this label was redundant. */}
    </motion.header>
  );
}
